...
RUN cd /ckb-graphql-server && git checkout 151efe723a507f657a5339a1f205ad8ea4cd8503 && cargo build --release
...
RUN wget https://github.com/nervosnetwork/ckb/releases/download/v0.26.1/ckb_v0.26.1_x86_64-unknown-linux-gnu.tar.gz -O /tmp/ckb_v0.26.1_x86_64-unknown-linux-gnu.tar.gz
RUN cd /tmp && tar xzf ckb_v0.26.1_x86_64-unknown-linux-gnu.tar.gz
RUN cp /tmp/ckb_v0.26.1_x86_64-unknown-linux-gnu/ckb /bin/ckb
...
RUN rm -rf /tmp/ckb_v0.26.1_x86_64-unknown-linux-gnu/ckb /tmp/goreman /tmp/dumb-init.deb
